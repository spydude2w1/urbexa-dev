        ...
        <section className="mb-20 md:mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-card border border-border rounded-lg p-6 md:p-8 transition-all duration-700 hover:border-gold/30 animate-settle opacity-0 animation-delay-500">
              <h3 className="font-serif text-xl font-light text-foreground mb-4">BBMP Approval</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Bruhat Bengaluru Mahanagara Palike approvals for residential building plans, plan sanctions, and municipal compliance within city limits.
              </p>
            </div>
            <div className="bg-card border border-border rounded-lg p-6 md:p-8 transition-all duration-700 hover:border-gold/30 animate-settle opacity-0 animation-delay-600">
              <h3 className="font-serif text-xl font-light text-foreground mb-4">BDA Approval</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Bangalore Development Authority approvals for layout planning, land development, and regulated zones under BDA jurisdiction.
              </p>
            </div>
        ...
        <section className="mb-20 md:mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-card border border-border rounded-lg p-6 md:p-8 transition-all duration-700 hover:border-gold/30 animate-settle opacity-0 animation-delay-1000">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Directorate of Town and Country Planning approvals for layout and development compliance as per Tamil Nadu planning regulations.
              </p>
            </div>
            <div className="bg-card border border-border rounded-lg p-6 md:p-8 transition-all duration-700 hover:border-gold/30 animate-settle opacity-0 animation-delay-1100">
              <h3 className="font-serif text-xl font-light text-foreground mb-4">HNTDA Approval</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Hosur New Town Development Authority approvals for residential and mixed-use developments within the Hosur planning jurisdiction.
              </p>
            </div>
          </div>
        </section>
